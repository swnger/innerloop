...
<section bind:this={root} class="scene">
	...
	<div class="diagram-shell" data-diagram-panel>
		<DiagramPanel label="Stub diagram" caption="A placeholder for the outer loop">
			<p>
				<q>context engineering chooses what enters each model call; harness engineering is the surrounding
				loop, tools, retries, orchestration, and guardrails.</q> This stub will later show how that outer
				loop keeps a model call moving while the inner work changes.
			</p>
		</DiagramPanel>
	</div>
