<script lang="ts">
    ...
    import {
        END,
        INFERENCE_DISTRIBUTIONS as DISTS,
        INFERENCE_LEDE_WORDS as LEDE,
        INFERENCE_MAX_GEN as MAX_GEN,
        INFERENCE_PRESETS as NT_PRESETS,
        INFERENCE_REPLY_TOKENS as REPLY,
        type Cand,
    } from "$lib/content/inference";
    import { chapterNumberFor } from "$lib/content/loopPath";
    import { macroCapable } from "$lib/loop.svelte";

    const CHAPTER_NUMBER = chapterNumberFor("inference");
        ...
        <div class="nt-open-stage">
            ...
            <div class="open-below">
                ...
                <div class="open-title chapter-head">
                    <p class="eyebrow">Chapter {CHAPTER_NUMBER} · the machine’s only trick</p>
